 ...
 * @author Shai Almog
 */
public class GoogleMapsDemoStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "GoogleMapsDemo";
    ...
    private GoogleMapsDemo mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new GoogleMapsDemoStub());
    }
